...
-- User_Artist [rel9]
alter table "public"."artist"  add column  "user_id"  int4;
alter table "public"."artist"   add constraint fk_artist_user foreign key ("user_id") references "public"."user" ("id");
